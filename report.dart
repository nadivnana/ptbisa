...
class DownLineHarian extends StatefulWidget {
  final User isi;
  const DownLineHarian({Key key, this.isi}) : super(key: key);

  @override
  _DownLineHarianState createState() => _DownLineHarianState();
}

class _DownLineHarianState extends State<DownLineHarian> {
  ...
  bool _loading = false;
  String page = "Downline Harian";
  search()async{ // check to server
    try {
      var url =
      Uri.http('${widget.isi.ipServer}', '/api_bisa/api_bisa/downline_harian');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Downline Harian", style: TextStyle(color: Color(0xFFfbfbfb)),),
      ),
      body: StreamBuilder(
